...
@interface HMAssistantViewController ()
...
@implementation HMAssistantViewController
...
- (void)loadView
{
    ...
    NSArray * options = @[
                          NSLocalizedString(@"花销统计", nil),
                          NSLocalizedString(@"自驾指导", nil),
                          NSLocalizedString(@"自驾帮助", nil),
                          ];
    
    self.listMenu = [[HMListMenuView alloc] initWithTitle:NSLocalizedString(@"出行列表", nil)
                                                  options:options];
