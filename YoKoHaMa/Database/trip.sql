...
INSERT OR REPLACE INTO Items (name, categoryIdentifier) VALUES ('绷带', 4), ('创可贴',4), ('消毒药水',4), ('消炎药',4), ('晕车药',4), ('驱蚊虫药水等',4);

INSERT OR REPLACE INTO Items (name, categoryIdentifier) VALUES ('多功能手表', 5), ('指南针',5), ('移动电话',5), ('组合刀具',5), ('对讲机',5);

INSERT OR REPLACE INTO Items (name, categoryIdentifier) VALUES ('全套随车工具', 6), ('备用轮胎',6), ('牵引绳',6), ('备用油桶',6), ('水桶',6), ('工兵铲等',6);

INSERT OR REPLACE INTO Trips (name) VALUES ('草原之旅'), ('高原之行'), ('海边度假'), ('沙漠探险');

INSERT OR REPLACE INTO TripItems (tripIdentifier, itemIdentifier, itemName) SELECT t.identifier, i.identifier, i.name FROM Trips t, Items i;
