...
+ (void)initWithMainview:(UIView *)underlayingView andStartRect:(CGRect)rect {
	id sender;
    sender = [[THZoomPopup sharedInstance] initWithMainview:underlayingView andStartRect:rect];
}
...
+ (void)showPopup:(UIView *)viewToDisplay {
	[[THZoomPopup sharedInstance] showPopup:viewToDisplay];
}
 ...
 */
+ (void)closePopup {
	[[THZoomPopup sharedInstance] closePopup];
}
...
+(void) setBorderSize: (CGFloat) borderSize {
    [THZoomPopup sharedInstance].borderSize = borderSize;
}

+(void)  setBorderColor: ( UIColor*) borderColor{
    [THZoomPopup sharedInstance].borderColor = borderColor;
}
+(void) setShadowRadius: ( CGFloat) shadowRadius{
    [THZoomPopup sharedInstance].shadowRadius = shadowRadius;
}
+(void) setBackgroundAlpha: (CGFloat) backGroundAlpha{
    [THZoomPopup sharedInstance].backGroundAlpha = backGroundAlpha;
}
+(void) setBlurRadius: (NSInteger) blurRadius{
    [THZoomPopup sharedInstance].blurRadius = blurRadius;
}
